...
# Input
SOURCES += Bot.cpp main.cpp Parser.cpp Region.cpp SuperRegion.cpp Movement.cpp Project.cpp MapSearch.cpp Conquerer.cpp Attacker.cpp Defender.cpp Thorner.cpp Judge.cpp
